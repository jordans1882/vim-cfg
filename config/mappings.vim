...
function! s:append_modeline()
	let l:tpmodeline = printf(' {{{ vim modeline')
	let l:btmodeline = printf(' }}} vim modeline')
	let l:modeline = printf(' vim: set foldmethod=marker ts=%d sw=%d tw=%d %set :',
				\ &tabstop, &shiftwidth, &textwidth, &expandtab ? '' : 'no')
	let l:tpmodeline = substitute(&commentstring, '%s', l:tpmodeline, '')
	let l:btmodeline = substitute(&commentstring, '%s', l:btmodeline, '')
	let l:modeline = substitute(&commentstring, '%s', l:modeline, '')
	call append(line('$'), l:tpmodeline)
	call append(line('$'), l:modeline)
	call append(line('$'), l:btmodeline)
endfunction
" }}}
